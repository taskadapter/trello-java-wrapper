...
public class RestTemplateHttpClient implements TrelloHttpClient {
    ...
    public <T> T postForObject(String url, Object object, Class<T> objectClass, String... params) {
        return execute(() -> restTemplate.postForObject(url, object, objectClass, (Object[]) params));
    }

    @Override
    public URI postForLocation(String url, Object object, String... params) {
        return execute(() -> restTemplate.postForLocation(url, object, (Object[]) params));
    }

    @Override
    public <T> T get(String url, Class<T> objectClass, String... params) {
        return execute(() -> restTemplate.getForObject(url, objectClass, (Object[]) params));
    }

    @Override
    public <T> T putForObject(String url, Object object, Class<T> objectClass, String... params) {
        return execute(() -> restTemplate.exchange(url, HttpMethod.PUT, new HttpEntity<>(object), objectClass, (Object[]) params)
                .getBody());
    }
